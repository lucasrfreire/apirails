...
# Aqui é para dar require automatico em todos os arquivos da pasta support para dentro
# dos arquivos de testes
...
RSpec.configure do |config|
  ...
  # Apenas um atalho para não ter que ficar chamando FactoryGirl.algumacoisa sempre que for chamar algum metódo dele
  config.include FactoryGirl::Syntax::Methods
  # Modulo a ser carregado sempre que o teste for do tipo request
